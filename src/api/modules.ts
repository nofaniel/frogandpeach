...
export const moduleDefinitions: ModuleDefinition[] = [
  {
    ...
    settings: [
      ...
      },
      {
        ...
        description: 'Show immersive CSS animations that reflect current weather conditions on the observatory page. Disable for lower-power devices or to respect motion preferences.',
        defaultValue: true,
      },
    ],
  },
