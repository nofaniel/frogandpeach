...
describe('getHomeListEntries', () => {
  it('returns all lists sorted by recency when none have incomplete items in default mode', () => {
    const older = makeList('older', { updatedAt: '2026-01-01T00:00:00Z', items: [{ id: 'i1', text: 'x', done: true, completedAt: null, metadata: {}, createdByName: null, updatedByName: null }] })
    const newer = makeList('newer', { updatedAt: '2026-06-01T00:00:00Z', items: [{ id: 'i2', text: 'y', done: true, completedAt: null, metadata: {}, createdByName: null, updatedByName: null }] })
  ...
  it('surfaces lists with incomplete items first in default mode', () => {
    ...
    const withItem = makeList('active', { updatedAt: '2026-01-01T00:00:00Z', items: [{ id: 'i1', text: 'x', done: false, completedAt: null, metadata: {}, createdByName: null, updatedByName: null }] })
  ...
  it('counts only incomplete items for incompleteCount', () => {
    const list = makeList('a', {
      items: [
        { id: 'i1', text: 'done', done: true, completedAt: null, metadata: {}, createdByName: null, updatedByName: null },
        { id: 'i2', text: 'open', done: false, completedAt: null, metadata: {}, createdByName: null, updatedByName: null },
        { id: 'i3', text: 'open2', done: false, completedAt: null, metadata: {}, createdByName: null, updatedByName: null },
      ],
    })
  ...
  it('in starred mode, starred lists come before active unstarred lists', () => {
    ...
    const active = makeList('active', { updatedAt: '2026-06-01T00:00:00Z', items: [{ id: 'i1', text: 'x', done: false, completedAt: null, metadata: {}, createdByName: null, updatedByName: null }] })
